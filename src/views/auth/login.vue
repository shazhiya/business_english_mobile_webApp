...
export default {
  data() {
    return {
      username: this.$route.params.username !== undefined ? this.$route.params.username : '枝栉',
      password: this.$route.params.password !== undefined ? this.$route.params.password : '123456789',
      ...
      this.$store.dispatch('login', {username: this.username, password: this.password})
          .then(result => {
            if (result) {
              ...
              this.$store.dispatch('loadMyself').then(()=>{
