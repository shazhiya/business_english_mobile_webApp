        ...
        <van-row>
            <van-col span="19" offset="2">
                <div style="margin: 10px">
                    <van-radio-group v-model="question.answer" v-if="editable">
                        <anOption :editable="editable" v-for="option in question.options" :option="option" :key="option.optionAlpha"></anOption>
                    </van-radio-group>
                    <van-radio-group v-model="question.doneAnswer" v-else>
                        <anOption :editable="editable" v-for="option in question.options" :option="option" :key="option.optionAlpha" :show-right="showRight&&option.optionAlpha===question.answer"/>
                    </van-radio-group>
                </div>
            </van-col>
        </van-row>
