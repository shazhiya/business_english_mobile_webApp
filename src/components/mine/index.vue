              ...
              "
                    ...
                    <div class="body">
                        <el-row>
                            ...
                            <el-col :span="18" class="textRight gray">
                                <div>{{ info.userEmail }}</div>
                            </el-col>
                        </el-row>
                        <el-row class="margin">
                            <el-col :span="10">
                            ...
                            <el-col :span="14" class="textRight gray">
                                <div>{{ info.userRegisterdate }}</div>
                            </el-col>
                        </el-row>
                        <el-row class="margin">
                            <el-col :span="8">
                            ...
                            <el-col :span="16" class="textRight gray">
                                <div>{{ info.userTelephone }}</div>
                            </el-col>
                        </el-row>
                        <el-row class="margin">
                            <el-col :span="4">
